...
public class Frag2 extends Fragment implements RecyclerViewAdapter.OnMovieListener {
    ...
    private void callMovies() {
        ...
        call.enqueue(new Callback<MovieResults>() {
            ...
            public void onResponse(Call<MovieResults> call, Response<MovieResults> response) {
                ...
                final RecyclerViewAdapter recyclerViewAdapter = new RecyclerViewAdapter(getContext(), arrayList, Frag2.this);
